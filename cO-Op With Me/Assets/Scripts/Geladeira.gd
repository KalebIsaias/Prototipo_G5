...
func _process(_delta):
	...
	# Botão para pegar o leite, só funciona quando o jogador aperta o "E", está na area, já pegou ovo antes e tem chocolate na geladeira.
	if Input.is_action_just_pressed("action") and in_area == 1 and Global.tem_ovo == 0 and Global.tem_leite == 1:
		Global.hide_slot = 1
		Global.pegou_leite = 1
		
		# Botão para pegar o chocolate, só funciona quando o jogador aperta o "E", está na area, já pegou ovo e leite antes e tem chocolate na geladeira.
